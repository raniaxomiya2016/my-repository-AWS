...
MyDBURI="rani-phonebook-rds.c02a5fjbhwyt.us-east-1.rds.amazonaws.com"
echo "${MyDBURI}" > /home/ec2-user/dbserver.endpoint

FOLDER="https://raw.githubusercontent.com/raniaxomiya2016/"my-repository/004-phonebook-web-application/"
